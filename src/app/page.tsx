...
export default function Home() {
  return (
    <main className="grid grid-cols-2 min-h-screen">
      {/* Left */}
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-white/10 px-28 py-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
        {/* background blur */}
        ...
        <div className='space-y-5'>
          ...
          <div className='max-w-[420px] space-y-1'>
            ...
            <a href="" className='inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none hover:bg-green-600' style={{color:'#000'}}>CADASTRAR LEMBRANÇA</a>
          </div>
